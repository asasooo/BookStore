...
<div class="divBody">
	...
	<div class="divContent">
	  <div style="margin: 20px;">
		<img style="float: left; margin-right: 40px;" src="<c:url value='${img }'/>" width="150"/>
		<span style="font-size: 30px; color: #c30; font-weight: 900;">${msg }</span>
		<br/>
		<br/>
		<br/>
		<br/>
		<span style="margin-left: 300px;">     <a target="_top" style="font-size:25" href="<c:url value='/index.jsp'/>">点我返回主页</a></span>
	  </div>
	</div>
</div>
