...
<c:choose>
	<c:when test="${empty sessionScope.uid }">
		...
		<tr>
			...
			<td>
				<br/>
				<span class="spanEmpty">&nbsp;请您先登陆会员！</span>
			</td>
		</tr>
	</table> 
	</c:when>
...
<c:forEach items="${cartList }" var="cartItem">
	<tr align="center">
		...
		<td align="left" width="400px">
		    <a style="font-size:22px;font-family:YouYuan;" href="<c:url value='/BookServlet?method=findByBid&bid=${cartItem.book.bid }'/>"><span>${cartItem.book.bname }</span></a>
		</td>
		<td><span style="font-size:18px;color:#F08080;font-weight:bold">&yen;<span style="font-size:18px; color:#F08080;font-weight:bold" class="currPrice">&nbsp;${cartItem.book.currPrice }</span></span></td>
		<td>
		...
		<td width="100px">
			<span class="price_n">&yen;<span class="subTotal"  style="font-size:18px;color:#F08080;" id="${cartItem.cartItemId }Subtotal">${cartItem.subtotal }</span></span>
		</td>
		<td>
