...
<div class="divBody">
	...
	<div class="divContent">
	  <div style="margin: 20px;">
		...
		<br/>
		<br/>
		<span style="margin-left: 100px;">     <a target="_top" style="font-size:25" href="<c:url value='/jsps/user/login.jsp'/>">登录</a></span>
		       
		<span style="margin-left: 300px;">     <a target="_top" style="font-size:25" href="<c:url value='/index.jsp'/>">主页</a></span>
	  </div>
	</div>
</div>
